...
<title>Password reminder - Zodiac Killer Facts Image Gallery</title>
        ...
        <div class="cpg_header_block_inner">
            <div id="main_menu">
                    <ul class="dropmenu">
                        ...
                        <!-- BEGIN login -->
                        <li>
                            <a href="login.php?referer=forgot_passwd.php" title="Log me in"  class="firstlevel" ><span class="firstlevel"><img src="images/icons/login.png" border="0" alt="" width="16" height="16" class="icon" />Login</span></a>
                        </li>
                        <!-- END login -->
