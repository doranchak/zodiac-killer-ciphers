...
public class TournamentSelection extends SelectionMethod implements SteadyStateBSourceForm
    ...
    public boolean betterThan(Individual first, Individual second, int subpopulation, EvolutionState state, int thread)
        {
        boolean result = first.fitness.betterThan(second.fitness);
        
        //String a1 = Arrays.toString(((MultiObjectiveFitness)first.fitness).objectives) + ", " + ((SPEA2MultiObjectiveFitness)first.fitness).fitness;
        //String a2 = Arrays.toString(((MultiObjectiveFitness)second.fitness).objectives) + ", " + ((SPEA2MultiObjectiveFitness)second.fitness).fitness;
        //System.out.println(a1 + " better than " + a2 + "? " + result);
        
        //System.out.println("first " + first.hashCode() + " better than second " + second.hashCode() + "? " + result + " fit1:" + first.fitness + " fit2:" + second.fitness);
        return result;
        }
    ...
    public int produce(final int subpopulation,
        ...
        //System.out.println("ts best " + best);
        return best;
        }
