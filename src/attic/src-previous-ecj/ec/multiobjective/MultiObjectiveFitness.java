...
public class MultiObjectiveFitness extends Fitness
    ...
    public float[] objectives; // values range from 0 (worst) to 1 INCLUSIVE
    ...
    */
    ...
    public boolean betterThan(Fitness fitness)
        {
        boolean better = paretoDominates((MultiObjectiveFitness)fitness);
        
        String a1 = Arrays.toString(((MultiObjectiveFitness)fitness).objectives);
        String a2 = Arrays.toString(((MultiObjectiveFitness)fitness).objectives);
        
        System.out.println(a1 + " better than " + a2 + "? " + better);
        return better;
        }
    ...
    public boolean paretoDominates(MultiObjectiveFitness other)
        ...
        if (maximize)
            ...
            for (int x = 0; x < objectives.length; x++)
                ...
                if (objectives[x] > other.objectives[x])
                	...
                	//System.out.println("SMEG paretoDominates false, this " + this.fitnessToStringForHumans() + ", other " + other.fitnessToStringForHumans());
                    return false;
                }
                }
            }
    	...
    	//System.out.println("SMEG paretoDominates " + abeatsb + ", this " + this.fitnessToStringForHumans() + ", other " + other.fitnessToStringForHumans());
        return abeatsb;
        }
    ...
    public static ArrayList partitionIntoParetoFront(Individual[] inds, ArrayList front, ArrayList nonFront)
        ...
        //if (front != null) for (Object o : front) System.out.println("SMEG FRONT MEMBER " + info(o));
        //if (nonFront != null) for (Object o : nonFront) System.out.println("SMEG NON-FRONT MEMBER " + info(o));
        return front;
        }
    ...
    public static int[] getRankings(Individual[] inds)
        ...
        //for (int i=0; i<r.length; i++) System.out.println("SMEG RANK " + r[i] + " FOR " + info(inds[i]));
        return r;
        }
