...
public class Evolve extends Problem implements SimpleProblemForm {
	...
	public static double pcsz340 = HomophonesNew.perfectCycleScoreFor(2, Ciphers.cipher[0].cipher, 3, false);
...
/*else {
	...
	public static boolean objectives56(double[] objectives, String cipher) {
		...
		double score1 = Math.abs(pcsz340 - HomophonesNew.perfectCycleScoreFor(2, cipher, 3, false));
	...
	public static boolean objectives55(double[] objectives, String cipher) {
		...
		// perfect cycle score (L=2)
		objectives[i++] = Math.abs(pcsz340 - HomophonesNew.perfectCycleScoreFor(2, cipher, 3, false));
		return true;
	}
	/*
	...
	public static boolean objectives51(double[] objectives, CandidateKey key) {
		...
		// perfect cycle score (L=2)
		objectives[i++] = Math.abs(MeasurementsBean.referenceBean.perfectCycleScore2 - HomophonesNew.perfectCycleScoreFor(2, cipher, 3, false));
		// pivot score
