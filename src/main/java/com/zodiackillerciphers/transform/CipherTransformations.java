...
public class CipherTransformations {
	...
	/** simple version of vertical flip */
	public static String flipVertical(String str, int rows, int cols) {
		StringBuffer flip = new StringBuffer();
		for (int row=rows-1; row>=0; row--) {
			for (int col=0; col<cols; col++) {
				flip.append(str.charAt(row*cols+col));
			}
		}
	...
	public static void main(String[] args) {
		...
		//testMerge();
		//testDelete();
		System.out.println(flipVertical(Ciphers.Z340, 20, 17));
	}
