...
public abstract class TransformationBase implements Transformation {
	...
	public void mapTransform(int positionOriginal, int positionTransformed) {
		if (transformMap == null) transformMap = new HashMap<Integer, Integer>();
		transformMap.put(positionOriginal, positionTransformed);
	}
	...
	public static List<StringBuffer> toList(String cipher, int width, boolean pad) {
		...
		if (pad) TransformationBase.pad(list);
		return list;
	}
