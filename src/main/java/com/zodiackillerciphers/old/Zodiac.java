...
//		cipher[0],
	...
	public static String[] letterPool;
	 ...
	 */ 
	public static void initLetterPool() {
	...
	public static String getLetterRoulette(boolean upper) {
		if (letterPool == null)
			initLetterPool();
		String result = letterPool[rand.nextInt(letterPool.length)];
		if (upper)
...
*/				
	...
	public static void testLetterPool() {
		for (int i = 0; i < 100000; i++)
			System.out.print(getLetterRoulette(true));
	}
