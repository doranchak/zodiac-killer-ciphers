...
function drawCipher(cipher, width, szx, szy, sx, sy, gapx, gapy, id, color, drawCounter, reps, avg, count) {
	...
	html += "<span class=\"h\" style=\"color: #900; position: absolute; left: 80px; top: 5px;\">TO TIMES-HERALD</span>";
	html += "<span class=\"h\" style=\"color: #900; position: absolute; left: 115px; top: 232px;\">TO EXAMINER</span>";
	html += "<span class=\"h\" style=\"color: #900; position: absolute; left: 110px; top: 455px;\">TO CHRONICLE</span>";
